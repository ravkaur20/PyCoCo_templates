...
class KernelConfig:
    ...
    def default_bounds(self) -> list[tuple[float, float]]:
        ...
        bounds: dict[str, tuple[float, float]] = {
            ...
            # Spec floor at log(0.01): keep spectroscopy jitter from dropping far
            # below the photometric floor so dense spec rows do not dominate the
            # time axis at fixed λ (see plot_bands_gp_overview phot residuals).
            "log_sigma_spec": (np.log(0.01), 0.0),
