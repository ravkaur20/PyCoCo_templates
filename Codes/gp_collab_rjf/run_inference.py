...
This module refactors logic from ``gp_rjf/run_gp.py`` so PyCoCo can call it in-process
...
def main_cli(argv: Optional[list[str]] = None) -> int:
    """Minimal CLI: ``python -m gp_collab_rjf.run_inference --input bundle.npz``."""
    import argparse
    ...
    print("[gp_collab_rjf] wrote", pred_path)
    return 0
